...
class Ui_PackagesDialog(object):
    ...
    def retranslateUi(self, PackagesDialog):
        ...
        self.comboFilter.setItemText(2, _translate("PackagesDialog", "Component Packages", None))
        self.comboFilter.setItemText(3, _translate("PackagesDialog", "Component+ Packages", None))
